...
export default function Update() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://contact-app-server-nxgi.onrender.com/api/v1/contactapp/findById?id=${params.contactId}`
      )
      .then((response) => {
    ...
    <div className="w-ful flex flex-col justify-center items-center">
      <div className="md:max-w-4xl w-11/12 flex flex-col justify-between py-8">
        ...
        <form onSubmit={updateContact} className="flex flex-col gap-4">
          ...
          <button type="submit" className="mt-5 py-3 px-6 bg-black text-white rounded-lg text-base">Update</button>
